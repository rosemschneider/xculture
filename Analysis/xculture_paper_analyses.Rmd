...
##Visualization of Unit performance by language: Faceted by CP vs. Subset
```{r}
#HK/SLO/US
all.data %>%
...
##Test of mean performance between languages
First HK/SLO/US
```{r}
#hk and slo 
sf.ms <- all.data %>%
...
Note that there is a lot more variability in highest counts and highest contiguous NN than in categorical variables. I am centering & scaking age, and centering and scaling FHC, IHC, and highest contiguous NN (which has the most variability).
```{r, include = FALSE}
##HK##
###UNIT###
...
#Experiment 2: Within-language Unit Task models
