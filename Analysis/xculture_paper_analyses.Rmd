...
ggsave("Figures/HKSLOUS_dens.png")
```
...
## Experiment 2 (Comparison to US English)
...
# SOM 3: Replication of Cheung et al. (2017) for US English children 
...
# SOM 5: Mean performance by counting resilience
...
### Hindi: Significant difference between groups (*p* = .03)
...
### Gujarati: Significant difference between groups (*p* = .001)
...
### Indian English: Significant difference between groups (*p* = .0005)
