...
all.data %>%
  ...
  ggplot(aes(x = IHC, y = prod.gradient, colour = Productive)) +
  geom_point() + 
  theme_bw() +
...
##Model comparisons
###Base v. productivity - NS, Chisq(1) = 0.064. p = .80
```{r}
...
###Base v. FHC - Sig, Chisq(1) = 18.17, p < .0001, AIC = 1491.8
```{r}
anova(sf.us.within.base, sf.us.within.model2, test = 'LRT')
```

###Base v. IHC - Sig, Chisq(1) = 49.01, p < .0001, AIC = 1461
```{r}
anova(sf.us.within.base, sf.us.within.model3, test = 'LRT')
````

###Base v. Highest Contig. - Sig, Chisq(1) = 35.49, p < .0001, AIC = 1474.5
```{r}
...
###HK: Marginally significant difference between groups (*p* = .05)
```{r}
...
##Model comparisons
###Base v. Productivity - Sig, Chisq(1) = 15.492, p < .0001, AIC = 1025.6
```{r}
anova(wcn.us.within.base, wcn.us.within.model1, test = 'LRT')
```

###Base v. FHC - Sig, Chisq(1) = 45.03, p < .0001, AIC = 996.02
```{r}
...
###Base v. FHC - Sig, Chisq(1) = 21.07, p < .0001, AIC = 669.74
```{r}
anova(wcn.ind.eng.within.base, wcn.ind.eng.within.model2, test = 'LRT')
```

###Base v. IHC - Sig, Chisq(1) = 19.32, p < .0001, AIC = 671.49
```{r}
...
###Base v. Highest contig. - Sig, Chisq(1) = 27.051, p < .0001, AIC = 4276.3
```{r}
...
###Base v. Highest contig. - Sig, Chisq(1) = 13.13, p = .0003, AIC = 3901.1
```{r}
...
##Model comparisons
###Base v. Productivity - Sig, Chisq(1) = 10.02, p = .002, AIC = 2506.9
```{r}
anova(wcn.cross.base.india, wcn.cross.model1.india, test = 'LRT')
```

###Base v. FHC - Sig, Chisq(1) = 23.135, p < .0001, AIC = 2493.8
```{r}
anova(wcn.cross.base.india, wcn.cross.model2.india, test = 'LRT')
```

###Base v. Prod. gradient - Sig, Chisq(1) = 16.272, p < .0001, AIC = 2500.7
```{r}
...
##Model comparisons
###Base v. Productivity - Sig, Chisq(1) = 16.553, p < .0001, AIC = 2856.8
```{r}
anova(wcn.cross.base, wcn.cross.model1, test = 'LRT')
```

###Base v. FHC - Sig, Chisq(1) = 37.87, p < .0001, AIC = 2835.5
```{r}
...
###Base v. FHC - Sig, Chisq(1) = 8.13, p = .004, AIC = 2107.6
```{r}
