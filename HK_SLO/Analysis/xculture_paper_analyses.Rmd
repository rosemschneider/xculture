...
nn.full %>%
  ...
  geom_count(show.legend = FALSE, alpha = .7) +
  geom_smooth(aes(fill = Language), se = TRUE, size = 1.6, alpha =.2) + 
  facet_grid(~IHC_FHC)+
...
##Pull out numbers that could never have been produced in Highest Count
