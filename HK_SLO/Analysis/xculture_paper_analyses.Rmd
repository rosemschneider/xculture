...
###IHC, FHC by language and productivity
```{r}
...
ggsave("~/Documents/Projects/xculture/HK_SLO/Analysis/Figures/Unit_by_language.png", width = 5.5, height = 2.8)
```
...
###Exploratory - Prod. gain - significant, Chisq. = 21.596, p < .0001
```{r}
...
###Post-hoc: Prod.gradient - Sig, Chisq(1) = 4.4, p = .04, AIC = 1507
```{r}
...
ggsave("~/Documents/Projects/xculture/HK_SLO/Analysis/Figures/Unit_by_HCNN.png", width = 5.5, height = 2.8)
```
